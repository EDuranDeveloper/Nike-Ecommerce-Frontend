...
export function WomenPage() {
  return (
    <div className="min-h-screen bg-[#E4DFDC] md:overflow-hidden">
      <Navbar />
      <main className="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-8 p-4 md:p-8">
        ...
        <section className="flex gap-8 items-center justify-center">
          ...
          <div className="flex flex-col">
            <div className="flex flex-col w-full max-w-[90vw] md:max-w-[600px] gap-y-4 mt-12 2xl:mt-32 md:overflow-hidden">
              <h1 className="text-4xl md:text-8xl text-[#2D2B2C] font-extrabold leading-tight">
            ...
            <div className="flex items-center mt-8 md:mt-12">
              <button className="bg-[#2D2B2C] text-white px-8 md:px-16 py-2 md:py-4 rounded-lg md:text-xl text-nowrap">
                Add to bag
              </button>
        ...
        <section className="md:ml-36 lg:ml-0 relative flex items-center justify-center h-[400px] lg:h-[600px] bg-[#d5cfcc] md:bg-transparent shadow-lg rounded-lg md:shadow-none md:rounded-none">
          <img
            className="transform md:rotate-[-49deg] absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 md:max-w-[100vw] lg:max-w-none h-auto 2xl:mt-48 4xl:mt-56 md:z-30 md:pb-24 delay-100 md:transition-transform duration-300 ease-in-out "
            src="/Woman.png"
            alt="Nike Image"
          />
        </section>
      ...
      {/* Fixed Image Gallery */}
      <div className="md:fixed bottom-0 left-0 w-full bg-[#ded7d2] rounded-lg shadow-lg flex md:justify-start justify-center items-center md:overflow-hidden p-4 gap-4 mt-8">
        <img
          className="md:size-48 h-24 rounded-lg"
          src="/NikeWoman1.jpeg"
          alt="Nike Image 1"
        />
        <img
